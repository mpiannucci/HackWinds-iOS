...
@property (nonatomic, readonly, copy) NSArray<UIColor *> * __nonnull valueColors;
...
- (UIColor * __nonnull)valueTextColorAt:(NSInteger)index;
...
/// List representing all colors that are used for drawing the actual values for this DataSet
@property (nonatomic, copy) NSArray<UIColor *> * __nonnull valueColors;
...
- (void)nsuiTouchesBegan:(NSSet<UITouch *> * __nonnull)touches withEvent:(UIEvent * __nullable)event;
- (void)nsuiTouchesMoved:(NSSet<UITouch *> * __nonnull)touches withEvent:(UIEvent * __nullable)event;
- (void)nsuiTouchesEnded:(NSSet<UITouch *> * __nonnull)touches withEvent:(UIEvent * __nullable)event;
- (void)nsuiTouchesCancelled:(NSSet<UITouch *> * __nullable)touches withEvent:(UIEvent * __nullable)event;
@property (nonatomic, readonly, strong) CALayer * __nullable nsuiLayer;
...
@property (nonatomic, strong) ChartData * __nullable _data;
...
@property (nonatomic, readonly, strong) ChartAnimator * __null_unspecified chartAnimator;
...
- (UIImage * __nullable)getChartImageWithTransparent:(BOOL)transparent;
...
///
/// \param easing 
- (void)zoomAndCenterViewAnimatedWithScaleX:(CGFloat)scaleX scaleY:(CGFloat)scaleY xIndex:(CGFloat)xIndex yValue:(double)yValue axis:(enum AxisDependency)axis duration:(NSTimeInterval)duration easing:(CGFloat (^ __nullable)(NSTimeInterval, NSTimeInterval))easing;
...
///
/// \param easing 
- (void)moveViewToAnimatedWithXIndex:(CGFloat)xIndex yValue:(double)yValue axis:(enum AxisDependency)axis duration:(NSTimeInterval)duration easing:(CGFloat (^ __nullable)(NSTimeInterval, NSTimeInterval))easing;
...
///
/// \param easing 
- (void)centerViewToAnimatedWithXIndex:(CGFloat)xIndex yValue:(double)yValue axis:(enum AxisDependency)axis duration:(NSTimeInterval)duration easing:(CGFloat (^ __nullable)(NSTimeInterval, NSTimeInterval))easing;
...
@property (nonatomic, strong) UIColor * __nullable neutralColor;
...
@property (nonatomic, strong) UIColor * __nullable zeroLineColor;
...
@property (nonatomic, copy) NSArray<NSNumber *> * __nullable zeroLineDashLengths;
...
- (void)drawZeroLineWithContext:(CGContextRef __nonnull)context x1:(CGFloat)x1 x2:(CGFloat)x2 y1:(CGFloat)y1 y2:(CGFloat)y2;
- (void)renderLimitLinesWithContext:(CGContextRef __nonnull)context;
@end
...
@property (nonatomic, strong) UIColor * __nullable scatterShapeHoleColor;
...
/// </code>
@property (nonatomic, strong) UIColor * __nullable transparentCircleColor;
...
- (void)drawDataSetWithContext:(CGContextRef __nonnull)context dataSet:(id <IRadarChartDataSet> __nonnull)dataSet mostEntries:(NSInteger)mostEntries;
- (void)drawValuesWithContext:(CGContextRef __nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef __nonnull)context;
...
- (CGPoint)nsuiLocationOfTouch:(NSInteger)touch inView:(UIView * __nullable)inView;
@end
...
@property (nonatomic, readonly, copy) NSArray<UIGestureRecognizer *> * __nullable nsuiGestureRecognizers;
@end
